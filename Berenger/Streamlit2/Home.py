...
def main():
    ...
    pages = {
        'Home': button_home_func,
        'Basics': button_basics_func,
        'Strategy': button_strategy_func,
        'Season': button_season_func,
        'Analysis': button_analysis_func,
        }
    ...
    st.write(list(pages.keys())[0])

    col1, col2, col3, col4, col5, col6, col7 = st.columns([4, 2, 2, 2, 2, 2, 4])

    with col2:
        page = st.button("‎ ‎ ‎ F1 Basics ‎ ‎ ‎ ")

    with col3:
        page = st.button("F1 Season 2022")

    with col4:
        page = st.button("‎ ‎ ‎ ‎ ‎ Home ‎ ‎ ‎ ‎ ‎ ")

    with col5:
        page = st.button("Race Analysis")      

    with col6:
        page = st.button("Race Strategy")
...
def button_basics_func():
    st.write("Rien pour l'instant")

def button_season_func():
    st.write("Rien pour l'instant")



def button_analysis_func():
